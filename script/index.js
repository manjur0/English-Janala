...
//               <h2 class="text-2xl font-bold">Eager</h2>
//               <p class="text-xl font-semibold my-4">Meaning /Pronounciation</p>
//               <h2 class="text-2xl font-bold">"আগ্রহী / ইগার"</h2>
//             </figure>
//             <!-- Modal  -->
...
//     .then((res) => res.json())
//     .then((data) => displayAllLevelsWords(data.data));
// };

// // display the modal with words details
// // const displayWordDetails = (word) => {
// //   displayAllLevelsWords(word);
// //   console.log(word);
// //   const modalContainer = document.getElementById("modalContainer");
// //   const div = document.createElement("div");
// // };
...
// // display Levels Words
// const displayAllLevelsWords = (levels, word) => {
//   console.log(word);
//   const vocabCard = document.getElementById("vocabCard");
//   vocabCard.textContent = "";
//   // Length 6 is showed by slicing
...
const displayWordDetails = (word) => {
  console.log(word);
  // get the level id from the word object
  const levelId = word.level_id;
  // fetch the level data again
  fetch(`https://openapi.programming-hero.com/api/level/${levelId}`)
    .then((res) => res.json())
    .then((data) => displayAllLevelsWords(data, word.id));
};

// display Levels Words
const displayAllLevelsWords = (levels, wordId) => {
  console.log("wordId:", wordId); // Now you can use wordId here
  const vocabCard = document.getElementById("vocabCard");
  vocabCard.textContent = "";
  // Length 6 is showed by slicing
  if (levels) {
